...
@Component({
  selector: 'app-blockspans-home-addstrike',
  templateUrl: './blockspans-home-addstrike.component.html',
  styleUrls: ['./blockspans-home-addstrike.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class BlockspansHomeAddstrikeComponent implements OnInit, OnDestroy {
