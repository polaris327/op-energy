...
@Component({
  selector: 'app-blockchain-bets',
  templateUrl: './blockchain-bets.component.html',
  styleUrls: ['./blockchain-bets.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class BlockchainBetsComponent implements OnInit, OnDestroy {
