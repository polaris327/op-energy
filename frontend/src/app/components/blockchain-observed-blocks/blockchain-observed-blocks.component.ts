...
@Component({
  selector: 'app-blockchain-observed-blocks',
  templateUrl: './blockchain-observed-blocks.component.html',
  styleUrls: ['./blockchain-observed-blocks.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class BlockchainObservedBlocksComponent implements OnInit, OnDestroy {
